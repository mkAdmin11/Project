...
***Сервер 2***
<br/> Установка *nginx*, *Apache2*, *PHP* и потребующиея в дальнейшем библиотеки.
<br/> Первоначальная настройка:
...
> Форма обратной связи, за основу взят [этот](https://github.com/itchief/feedback-form) проект с GitHub, также внесены небольшие изменения в *PHP* код и *CSS* стили, форма упакована в страницу картинку.
...
>> На *Сервере 3* ранее подготовлена база данных и пользователь с правами доступа по *VPN* сети.
